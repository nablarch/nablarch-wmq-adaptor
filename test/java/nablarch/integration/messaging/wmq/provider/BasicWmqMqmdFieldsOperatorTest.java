...
public class BasicWmqMqmdFieldsOperatorTest {
    ...
    public static void loadRepository() {
        String path = BasicWmqMqmdFieldsOperatorTest.class.getName().replace(".", "/") + ".xml";
    ...
    public void testSetFieldsBeforeSend() throws MQException {
        ...
        assertThat(mqMessage.putDateTime.getTimeInMillis(), CoreMatchers.is(FixedSystemTimeProvider.FIXED_DATE.getTime()));
